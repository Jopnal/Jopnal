...
#ifndef JOP_FONT2_HPP
#define JOP_FONT2_HPP
...
namespace jop
{
    class JOP_API Font2 : public Resource
    {
    private:

        JOP_DISALLOW_COPY_MOVE(Font2);
    ...
    public:
        ...
        ///
        static Font2& getError();

        /// \brief Get the default font
        ///
        /// \return Reference to the font
        ///
        static Font2& getDefault();
