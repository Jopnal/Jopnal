...
namespace jop
{
    ...
    Material& Material::setReflection(const Preset preset)
    {
        ...
        {
            std::make_tuple(Color(0.0215f,0.175f,0.0215f),Color(0.07568f,0.61424f,0.07568f),Color(0.633f,0.727811f,0.633f),128*0.6f),
        ...
        return setReflection(std::get<0>(presets[index]), std::get<1>(presets[index]), std::get<2>(presets[index]), Color::Black)
              .setShininess(std::get<3>(presets[index]));
    }
