...
namespace jop
{
    namespace Input
    {
        ...
        {
            using m = Controller::XBox::Button;
        ...
        int getJopTouchInfo(const int info)
        {
            ...
            switch (info)
            {
                ...
                case AMOTION_EVENT_AXIS_TOUCH_MAJOR:    return i::TouchMajor;
                case AMOTION_EVENT_AXIS_TOOL_MAJOR:     return i::ToolMajor;
            }
        ...
        int getGlTouchInfo(const int info)
        {
            ...
            switch (info)
            {
                ...
                case i::TouchMajor: return AMOTION_EVENT_AXIS_TOUCH_MAJOR;
                case i::ToolMajor:  return AMOTION_EVENT_AXIS_TOOL_MAJOR;
            }
