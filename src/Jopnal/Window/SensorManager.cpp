...
namespace jop
{
    ...
    bool SensorManager::isAvailable(Sensor::Type sensorType)
    {
    ...
    void SensorManager::enable(Sensor::Type sensorType)
    {
    ...
    void SensorManager::disable(Sensor::Type sensorType)
    {
    ...
    bool SensorManager::getStatus(Sensor::Type sensorType) const
    {
    ...
    glm::vec3 SensorManager::getData(Sensor::Type sensorType) const
    {
